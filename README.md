Esse é um projeto desenvolvido com [Next.js](https://nextjs.org/) com intuito de explorar o mundo Digimon utilizando a [Digimon API](https://digimon-api.vercel.app/).
